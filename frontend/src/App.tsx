    ...
    return (
        <div className={"h-screen w-screen relative"}>
            <div id={"editorContainer"}
                ...
                {/*<textarea
                    id="editorView"
                           className="w-full px-0 text-sm resize-none h-full outline-none border-none
                           overflow-auto
                            text-gray-800 bg-white border-0 dark:bg-gray-800
                             focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write an article..."
                onChange={async (e) =>{
                    const html = await ConvertMdToHTML(e.target.value)
